...
$sms_send_sql=	"SELECT DISTINCT(contact_id) FROM `contact_group` WHERE Service_contact_id ='0' AND `status` = 1";
				 ...
				 if($flag=="Sent")
								...
								{	
								 if(array_key_exists('test', $_POST))
									...
									print "<a href='../view_message_gk.php'>Go to  Message</a>";
									}
				 			 ...
				 			 while($row1=mysql_fetch_row($sql1))
				               {
								...
								mysql_query( "INSERT INTO `infocellvas`.`report` (`id`, `category_id`, `draft_message_id`, `count`, `date`) VALUES (NULL, '2', '$id', '$z', CURRENT_TIMESTAMP)");
