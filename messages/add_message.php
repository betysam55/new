                          ...
                          <div class="page-header">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="page-header-tools">
                                    <a class="btn btn-gradient-01" href="message.php">back to Messages</a>
                                </div>
                                </div>
                            </div>
                          </div>
                        ...
                        <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <form action="../services/messages/add_message.php?id=<?php echo $_GET['id']; ?>" method="POST" class="form-horizontal">
