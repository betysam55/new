                  ...
                  <div class="container-fluid">
                      ...
                      <?php 
                                                    ...
                                                    $number_of_rows=mysql_num_rows($result);
                                                     ...
                                                     ?>
                           <button type="button"  class="btn btn-gradient-01 btn-lg btn-block"><a class="btn btn-gradient-01 btn-lg btn-block" href="../messages/view_by_category.php?id=<?php  print($row['id']); ?>"><?php print($row['service_type']); ?></a></button>
                                                       <?php }?>
                                                 </div>
                          <div class="col">
