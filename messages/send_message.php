                        ...
                        <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    <div class="widget-header bordered no-actions d-flex align-items-center">
										...
										$sql = "SELECT * FROM `draft_message` WHERE `id` = '$id'";
	                                    ...
	                                    <div class="widget-body">
	                                        ...
	                                        <div class="input-group">
	                                        	<textarea type="text" class="form-control" name="content_id"  disabled=""><?php echo $row1["content"]; ?></textarea>
											 
											  <div class="input-group-append">
											    <a  href="edit_message.php?id=<?php print$id; ?>&&category_id=<?php print$category_id; ?>" <?php if($row1["status"]=="Sent")print('style="pointer-events:none;"'); ?> class="btn btn-gradient-01">
                                                    <?php if($row1["status"]=="Sent")print('Message cant be edited.All ready sent');else print('Edit'); ?></a>
											  </div>
											</div>
	                                    </div>
	                                    <div class="widget-body">
	                                    <form action="../services/messages/send_message.php" method="POST">
                                              ...
                                              <select name="short_code" class="custom-select form-control">
                                                ...
                                                <?php } ?>
                    										  ...
                    										  <div class="form " style="">
                    										  	<div class="col-6" style="overflow-y: scroll;max-height:300px;">
                    										      <div class="form-group">
                    											 <div class="mb-3">
