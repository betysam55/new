                        ...
                        <div class="col-xl-12">
                                ...
                                <div class="widget has-shadow">
                                    ...
                                    <div class="widget-body">
                                        <form action="../services/messages/edit_message.php?id=<?php echo $_GET['id']; ?>&&category_id=<?php print$category_id; ?>" method="POST" class="form-horizontal">
                                            <div class="form-group row d-flex align-items-center mb-5 has-success">
                                                ...
                                                <div class="col-sm-9">
                                                  <textarea maxlength="127" class="required  control col-lg-12" id="message" name="content" rows="6"  ><?php print($row['content']);  ?></textarea>
                                                </div>
