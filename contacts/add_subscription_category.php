                                ...
                                <div class="col-xl-12">
                                        ...
                                        <div class="widget has-shadow">
                                            ...
                                            <div class="widget-body">
                                                <form action="../services/contacts/add_subscription_category.php" method="GET">
                                                        <div class="form-group row mb-5">
                                                              <label class="col-lg-3 form-control-label">Select Service</label>
                                                              <div class="col-lg-9 select mb-3">
                                                                <input type="hidden" name="contact_id" value="<?php echo $_GET['contact_id']; ?>">
                                                                <input type="hidden" name="category" value="<?php echo $_GET['category']; ?>">
                                                                  <select name="service" class="custom-select form-control">
                                                                        <?php 
                                                                          include '../services/connection.php';
