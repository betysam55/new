                                          ...
                                          <table id="sorting-table" class="table mb-0">
                                              ...
                                              <tbody>
                                                <?php 
                                                    ...
                                                    $phone_number=$_GET['search_by_phone'];
                                                    ...
                                                    $total_pages_sql = "SELECT COUNT(*) FROM contacts WHERE `phone_number` LIKE '$phone_number'";
                                                    $result0 = mysql_query($total_pages_sql);
                                                    $total_rows = mysql_fetch_array($result0)[0];
                                                    $total_pages = ceil($total_rows / $no_of_records_per_page);
                                                    $sql = "SELECT * FROM `contacts` WHERE `phone_number` LIKE '%$phone_number%' ORDER BY `contacts`.`created_at` DESC LIMIT $offset, $no_of_records_per_page";
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td><span style="width:95px;"><span class="badge-text badge-text-small info"><?php if($row['status']=='1')print('Approved');else print('Waiting for Approval') ?></span></span></td>
                                                      <td class="td-actions">
