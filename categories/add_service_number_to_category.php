                          ...
                          <div class="row">
                              <div class="page-header">
                                <div class="d-flex align-items-center">
                                    <h2 class="page-header-title">Add Service Number to Category</h2>
                                    <div>
                                ...
                                <div class="col-xl-12">
                                        ...
                                        <div class="widget has-shadow">
                                            ...
                                            <div class="widget-body">
                                                <form action="../services/categories/add_service_number_to_category.php?id=<?php $id=$_GET['id'];echo$id; ?>" method="POST">
                                                <div class="form-group row mb-5">
                                                <div class="col-lg-9 select mb-3">
                                                    <select name="access_code_id" class="custom-select form-control">
                                                    	<?php 
                                                    include '../services/connection.php';
