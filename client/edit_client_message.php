...
<html lang="en">
    <head>
        ...
        <title>Edit Cleint message - Dashboard</title>
                                    ...
                                    <div class="widget-body">
                                        <form class="form-horizontal">
                                            ...
                                            <div class="form-group row mb-5">
                                                <label class="col-lg-3 form-control-label">text type</label>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5 has-success">
                                                ...
                                                <div class="col-sm-9">
                                                  <textarea maxlength="127" class="required  control col-lg-12" id="message" name="message" rows="6" ></textarea>
                                                </div>
