                              ...
                              <div class="page-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="page-header-tools">
                                        <a class="btn btn-danger" href="user_detail.php?id=<?php echo$id; ?>">Cancel</a>
                                    </div>
                            ...
                            <div class="row flex-row">
                                <div class="col-xl-12">
                                        ...
                                        <div class="widget has-shadow">
			                                ...
			                                <?php } ?>
			                                <form class="form-horizontal" action="../services/users/add_category_and_service.php" method="GET">
                                              <?php if(isset($_GET['next'])){ ?>
                                                <input type="hidden" name="short_code_id" value="<?php echo$_GET['short_code_id']; ?>">
                                                 <div class="form-group col-md-6">
                                                  ...
                                                  <div class="form-group col-md-6">
		                                            <div class="page-header-tools">
		                                                <button type="submit" class="btn btn-gradient-01 Right" name="submit" value="1" >Add</button>
		                                              </div></div>
		                                       <?php } ?>
		                                    </form>
