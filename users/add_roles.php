                              ...
                              <div class="page-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="page-header-tools">
                                        <a class="btn btn-danger" href="roles.php">Cancel</a>
                                    </div>
                                ...
                                <div class="col-xl-12">
                                        ...
                                        <div class="widget has-shadow">
                                            ...
                                            <div class="widget-body">
                                                <form action="../services/users/add_role.php" method="POST">
                                                      ...
                                                      <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" name="title" class="form-control" id="title" placeholder="Role Title">
                                                      </div>
                                                      <div class="form-group col-md-6">
