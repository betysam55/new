                              ...
                              <div class="page-header">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="page-header-tools">
                                        <a class="btn btn-danger" href="role_detail.php?id=<?php echo$_GET['role_id']; ?>">Cancel</a>
                                    </div>
                                ...
                                <div class="col-xl-12">
                                        ...
                                        <div class="widget has-shadow">
                                            ...
                                            <div class="widget-body">
                                                <form action="../services/users/add_permission_to_role.php" method="POST">
                                                     <div class="form-group col-md-6">
                                                        	<label for="permission_id">Role</label>
			                                                    <select id="permission_id" name="permission_id" class="custom-select form-control">
